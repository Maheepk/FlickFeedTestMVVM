...
public extension Float {
    ...
    func roundToDecimal(_ fractionDigits: Int) -> String {
        let multiplier = pow(10, Float(fractionDigits+1)) // +1 as we are taking upto 3 digit internally as some times in float comes more than 2 decimal values.
        let intValue = Int(self * multiplier)
        let mainValue = Float(intValue) / multiplier
