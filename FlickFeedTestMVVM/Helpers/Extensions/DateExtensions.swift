...
public extension Date {
    ...
    public var currentYTimeStampString: String {
        let timestamp =  Int64(self.timeIntervalSince1970 * 1000)
        return "\(timestamp)"
    }
    
    /// SwifterSwift: Hello Paisa Formated Date "YYYYMMDD"
    public var HPFormatedDate: String {
    ...
    /// SwifterSwift: Hello Paisa Formated Date "yyyy-MMM-dd"
    public var HPDispalyFormatedDateWithDashSeprator: String {
    ...
    /// SwifterSwift: Hello Paisa Formated Date "yyyy-MMM-dd"
    public var HPDispalyFormatedDateOneMonthAgoWithDashSeprator: String {
        let thirtyDaysBeforeToday = Calendar.current.date(byAdding: .day, value: -30, to: self)!
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MMM-dd"
        dateFormatter.locale = Locale(identifier: "en_US")
        let dateString = dateFormatter.string(from: thirtyDaysBeforeToday)
        return dateString
    }
    
    /// SwifterSwift: Hello Paisa Formated Date "yyyy MMM dd"
    public var HPDispalyFormatedDateWithSpaceSeprator: String {
    ...
    /// SwifterSwift: Hello Paisa Formated Date "yyyy MMM dd"
    public var HPDispalyFormatedDateOneMonthAgoWithSpaceSeprator: String {
        let thirtyDaysBeforeToday = Calendar.current.date(byAdding: .day, value: -30, to: self)!
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy MMM dd"
        dateFormatter.locale = Locale(identifier: "en_US")
    ...
    /// SwifterSwift: Hello Paisa Formated Date "YYYYMMDD" ONE month ago
    public var HPDateBeforeOneMonth: String {
        
        let thirtyDaysBeforeToday = Calendar.current.date(byAdding: .day, value: -30, to: self)!
        return thirtyDaysBeforeToday.HPFormatedDate
    }
    
    /// SwifterSwift: ONE month ago
    public var DateBeforeOneMonth: Date {
        
        let thirtyDaysBeforeToday = Calendar.current.date(byAdding: .day, value: -30, to: self)!
        return thirtyDaysBeforeToday
    }
    
    /// SwifterSwift: Three month ago
    public var DateBeforeThreeMonth: Date {
        
        let nintyDaysBeforeToday = Calendar.current.date(byAdding: .day, value: -90, to: self)!
        return nintyDaysBeforeToday
    }
    
    /// SwifterSwift: next Day
    ...
    /// SwifterSwift: previous Day
    public var PreviousDay: Date {
        
        let previousDay = Calendar.current.date(byAdding: .day, value: -1, to: self)!
        return previousDay
    }
    
    public var dayBeforeOneWeek : Date{
        let previousDay = Calendar.current.date(byAdding: .day, value: -7, to: self)!
        return previousDay
    }
    
    public var dayBeforeTwoWeek : Date{
        let previousDay = Calendar.current.date(byAdding: .day, value: -14, to: self)!
        return previousDay
    }
    ...
    public func dateAfterHours(hours : Int) -> Date{
        let date = Calendar.current.date(byAdding: .hour, value: hours, to: self)!
        return date
    }
